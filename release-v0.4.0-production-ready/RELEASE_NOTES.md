# crashcart-ng v0.4.0-production-ready Release Notes
...
wget https://github.com/user/crashcart-ng/releases/download/v0.4.0-production-ready/crashcart-ng-v0.4.0-production-ready.tar.gz
tar -xzf crashcart-ng-v0.4.0-production-ready.tar.gz
cd crashcart-ng-v0.4.0-production-ready
